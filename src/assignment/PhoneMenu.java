...
public class PhoneMenu {
    ...
    public static void tone(){
        System.out.printf("%n%s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%n%d:%s%n", "***TONES***", 1, "Ringing tone", 2, "Ringing volume", 3, " Incoming call alert", 4, "Composer", 5, "Message alert tone", 6, "Keypad tones", 7, "Warning and game tones", 8, "Vibrating alert", 9, "Screen Saver", 99, "Go back");
        String display = "No information to display";
        switch (enter()) {
            case 1-> {
                ringingTone();
    ...
    public static void phonebook(){
        System.out.printf("%n%s%n%d:%s%n%d:%s%n%d:%s%n%d:%s%n%d:%s%n%d:%s%n%d:%s%n%d:%s%n%d:%s%n%d:%s%n%n%d:%s%n", "***PHONE BOOK***", 1, "Search", 2, "Service Numbers", 3, "Add name", 4, "Erase", 5, "Edit", 6, "Assign tone", 7, "Send b.card", 8, "Options 💕", 9, "Speed dials", 10, "Voice tags", 99, "Go back");
        Scanner input = new Scanner(System.in);
        String display = "No information to display";
        switch(enter()) {
            case 1-> {
    ...
    public static void options() {
     System.out.printf("%n%s%n%d:%s%n%d:%s%n%n%d:%s%n", "***OPTIONS***", 1, "Type of view", 2, "Memory status", 99, "Go back");
        String display = "No information to display";
         switch (enter()) {
              case 1 -> {
                        typeOfView();
    ...
    public static void typeOfView(){
        System.out.printf("%n%s%n%d: %s%n", "***TYPE OF VIEW***",1, "Go back");
        if (enter() == 1) {
            options();
        }
    }
    ...
    public static void message(){
        System.out.printf("%n%s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%n%d: %s%n", "***MESSAGES***", 1, "Write Messages", 2, "Inbox", 3, "Outbox", 4, "Picture Messages", 5, "Templates", 6, "Smileys", 7, "Message Settings 💕", 8, "Info Service", 9, "Voice mailbox Number", 10, "Service command editor", 99, "Go back");
        String display = "No information to display";
        switch (enter()) {
            case 1-> {
                writeMessages();
    ...
    public static void messageSetting(){
        System.out.printf("%n%s%n%d: %s%n%d: %s%n%n%d: %s%n", "***MESSAGE SETTINGS***", 1, "Set 1 💕", 2, "Common 💕", 99, "Go back");
        String display = "No information to display";
        switch (enter()) {
            case 1-> {
                set1();
    ...
    public static void common () {
        String display = "No information to display";
        System.out.printf("%n%s%n%d: %s%n%d: %s%n%d: %s%n%n%d: %s%n", "***COMMON***", 1, "Delivery Report", 2, "Reply Via Same Centre", 3, "Character Support", 99, "Go back");
        switch (enter()) {
            case 1 -> {
                deliveryReport();
            }
    ...
    public static void set1() {
        String display = "No information to display";
        System.out.printf("%n%s%n%d: %s%n%d: %s%n%d: %s%n%n%d: %s%n", "***SET 1***", 1, "Message centre number", 2, "Message sent as", 3, "Message validity", 99, "Go back");
        switch (enter()) {
            case 1 -> {
                messageCentreNumber();
            }
    ...
    public static void callRegister(){
        System.out.printf("%n%s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%n%d: %s%n", "***CALL REGISTER***", 1, " Missed calls", 2, "Received calls", 3, "Dialled numbers", 4, "Erase recent call lists", 5, "Show call durations 💕", 6, "Show call cost 💕", 7, "Call cost settings 💕", 8, "Prepaid credits", 99, "Go back");
        String display = "No information to display";
                switch (enter()) {
        case 1-> {
            missedCalls();
    ...
    public static void showCallCost(){
     System.out.printf("%n%s%n%d: %s%n%d: %s%n%d: %s%n%n%d: %s%n","***SHOW CALL COSTS***", 1, " Last call cost", 2, "All call cost", 3, "Clear counters", 99, "Go back");
    String display = "No information to display";
    switch (enter()) {
        case 1-> {
            lastCallCost();
    ...
    System.out.printf("%n%s%n%d: %s%n%d: %s%n%n%d: %s%n", "***CALL COST SETTINGS***", 1, "Call cost limit", 2, "Show cost in", 99, "Go back");
        String display = "No information to display";
            switch (enter()) {
        case 1-> {
            costCallLimit();
    ...
    public static void costCallLimit(){
        System.out.printf("%n%s%n%d: %s%n", "***COST CALL LIMIT***",1, "Go back");
        if (enter() == 1) {
            callCostSetting();
        }
    }
    ...
    public static void showCallDuration(){
     System.out.printf("%n%s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%n%d: %s%n", "***SHOW CALL DURATION***", 1, "Last call duration", 2, "All calls duration", 3, "Received call duration", 4, "Dialled call duration", 5, "Clear Timers", 99, "Go back");
        String display = "No information to display";
            switch (enter()) {
        case 1-> {
            lastCallDuration();
    ...
    public static void allCallsDuration(){
        System.out.printf("%n%s%n%d: %s%n", "***ALL CALL DURATION***",1, "Go back");
        if (enter() == 1) {
            showCallDuration();
        }
    }
    ...
    public static void settings(){
     System.out.printf("%n%s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%n%d: %s%n", "***SETTINGS***", 1, "Call settings 💕", 2, "Phone settings 💕", 3, "Security settings 💕", 4, "Restore factory settings", 99, "Go back");
        String display = "No information to display";
        switch (enter()) {
            case 1-> {
               callSetting();
    ...
    public static void securitySettings(){
        System.out.printf("%n%s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%n%d: %s%n", "***SECURITY SETTINGS***", 1, "PIN code settings", 2, "Call barring service", 3, "Fixed dialing", 4, "Closed user group", 5, "Phone security", 6, "Change access codes", 99, "Go back");
        String display = "No information to display";
                        switch (enter()) {
        case 1-> {
            pINCodeSetting();
    ...
    System.out.printf("%n%s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%n%d: %s%n", "***PHONE SETTING***", 1, "Language", 2, "Cell info display", 3, "Welcome note", 4, "Network selection", 5, "Lights", 6, "Confirm SIM service actions", 99, "Go back");
        String display = "No information to display";
        switch (enter()) {
            case 1-> {
                language();
    ...
    public static void callSetting(){
        System.out.printf("%n%s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%n%d: %s%n", "***CALL SETTING***", 1, "Automatic redial", 2, "Speed dialing", 3, "Call waiting options", 4, "Own number sending", 5, "Phone line in use", 6, "Automatic answer", 99, "Go back");
        String display = "No information to display";
        switch (enter()) {
        case 1-> {
            automaticRedial();
...
//        int time = 0;
    ...
    public static void menu(){
        System.out.printf("%n%s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%d: %s%n%n%d: %s%n","***PHONE MENU***", 1, "Phonebook 💕", 2, "Message 💕", 3, "Chat", 4, "Call Register 💕", 5, "Tones 💕", 6, "Settings 💕", 7, "Call Diverts", 8, "Games",9, "Calculator", 10, "Reminders", 11, "Clock 💕", 12, "Profile", 13, "SIM Service", 99, "Exit");
        switch (enter()){
            case 1-> {
                phonebook();
            }
