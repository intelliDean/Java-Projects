...
public class ArrayManipulation {
    public static void toUseArrayClassMethod() {
        // sort doubleArray into ascending order
        double[] doubleArray = {8.4, 9.3, 0.2, 7.9, 3.4};
        Arrays.sort(doubleArray); // to sort the array in ascending form

        System.out.printf("%nSorted doubleArray: ");
